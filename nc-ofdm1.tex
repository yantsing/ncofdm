...
\begin{figure}[t]
\begin{center}
\includegraphics[scale=0.5]{receiver.pdf}
\end{center}
...
%Got by program POCS_upsample_J_SC.M%
%\begin{center}
%\includegraphics[scale = 0.4]{pocs_8db.pdf}
%\end{center}
...
\begin{figure}[t]
	%Got by program POCS_upsample_J_SC.M%
	\begin{center}
	\includegraphics[scale = 0.4]{process_process_papr.pdf}
      \end{center}
...
\begin{figure}[t]
	...
	\begin{center}
	\includegraphics[scale = 0.5]{comparison_3algorithms_new.pdf}
      \end{center}
...
%Got by program pocs1.m, pocs2.m, pocs3.m%
\begin{center}
\includegraphics[scale = 0.5]{comparison_3algorithms_obp_new.pdf}
\end{center}
